              ...
              onPressed: () {
                showDialog(
                  ...
                  builder: (context) => AlertDialog(
                    title: Text('Clear All Data', style: AppStyles.primaryBoldText(context, isPortrait)),
                    content: Text('Are you sure you want to clear all data? This action cannot be undone.', style: AppStyles.customText(context),),
                    actions: [
                      TextButton(
                        onPressed: () {
                          Navigator.of(context).pop();
                        },
                        child: Text('Cancel', style: AppStyles.customText(context, color: AppColor.whiteColor,),),
                      ),
                      TextButton(
                        onPressed: () async {
                        ...
                        child: Text('Clear All', style: AppStyles.customText(context, color: AppColor.whiteColor,),),
                      ),
                    ],
                  ),
                );
              },
              child: Text('Clear All Data', style: AppStyles.customText(context, color: AppColor.whiteColor,),),
            ) ,
            )
